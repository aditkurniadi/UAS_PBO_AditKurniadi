...
$data_karyawan = KaryawanKontrak::getAllKaryawanKontrak($db->koneksi);
...
<div class="px-4 sm:px-6 lg:px-8 mt-4">
    <div class="sm:flex sm:items-center">
        <div class="sm:flex-auto">
            <h1 class="text-base font-semibold text-gray-900 dark:text-white">Data Karyawan Kontrak</h1>
            <p class="mt-2 text-sm text-gray-700 dark:text-gray-300">Daftar seluruh karyawan kontrak yang terdaftar.</p>
        </div>
    </div>
